...
const pt = {
  ...
  receipts: {rnc: "RNC", encf: "e-NCF", date: "Data", store: "Loja", customer: "Cliente", document: "Documento", salesperson: "Vendedor", copy: "CÓPIA", creditInvoice: "FATURA A CRÉDITO", salesJournal: "DIÁRIO DE VENDAS", description: "DESCRIÇÃO", itbis: "IMPOSTO", value: "VALOR", quoted: "Cotado", discount: "Desconto", delivery: "Entrega", purchaseSavings: "Economia na compra (desconto)", articles: "Itens", paidToDate: "Total pago até agora", pendingBalance: "Saldo pendente", change: "Troco", thanks: "Obrigado pela compra", receipt: "Recibo", consumerFinal: "CONSUMIDOR FINAL", product: "PRODUTO", creditCard: "Cartão de crédito", cash: "Dinheiro"}
}
